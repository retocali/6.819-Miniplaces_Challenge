...
# Dataset Parameters
def run_alexnet(learning_rate, dropout = 0.5, batch_size = 16):	
...
for dropout in dropouts:
	acc1, acc5 = run_alexnet(0.001, dropout=dropout)
	acc1_list.append(acc1)
	acc5_list.append(acc5)

learning_rates = [0.005, 0.001, 0.0005, 0.0001]
for learning_rate in learning_rates:
	acc1, acc5 = run_alexnet(learning_rate, dropout = 0.5)
	acc1_list.append(acc1)
	acc5_list.append(acc5)

print 'Acc1 list: ', acc1_list, '\n'
print 'Acc2 list: ', acc5_list, '\n'
